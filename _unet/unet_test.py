...
nerve_model = keras.models.load_model(f'models/binary_nerve/default_dataset_distribution/unet_1_efficientnetb3_weighted_jaccard_loss_8_batch_size_256_size_crop_20_epoch_binary_nerve_0.01_true_weight_inc_lr_set_#5.h5',
...
ureter_model = nerve_model#keras.models.load_model(f'models/binary_ureter/equal_dataset_distribution/unet_1_efficientnetb3_weighted_jaccard_loss_8_batch_size_256_size_crop_20_epoch_binary_ureter_0.4_true_weight_equal_set_#5.h5',
                                #custom_objects={'jaccard_loss': jaccard_loss, 'jaccard_score_true_class': jaccard_score_true_class, 'jaccard_score_all': jaccard_score_all,
                                #                'dice_coef': dice_coef})

arthery_model = nerve_model#keras.models.load_model(f'models/binary_arthery/equal_dataset_distribution/unet_1_efficientnetb3_weighted_jaccard_loss_8_batch_size_256_size_crop_20_epoch_binary_arthery_0.45_true_weight_equal_set_#4.h5',
                                #custom_objects={'jaccard_loss': jaccard_loss, 'jaccard_score_true_class': jaccard_score_true_class, 'jaccard_score_all': jaccard_score_all,
                                #                'dice_coef': dice_coef})
...
test_dir = f'../dataset/test_dataset_crop_nerve/images'
test_mask_dir = f'../dataset/test_dataset_crop_nerve/mask'
...
for n in range(len(test_dataset)):
    ...
    jaccard_score_arthery_pixelwide += K.eval(jaccard_score_1(y, tf.keras.utils.to_categorical(prediction, num_classes= 4).astype('float64')))
    jaccard_score_arthery_region_based += K.eval(jaccard_score_1(y, tf.keras.utils.to_categorical(reg_pred_1, num_classes=4).astype('float64')))
    jaccard_score_arthery_multiclass += K.eval(jaccard_score_1(y, tf.keras.utils.to_categorical(p_multiclass, num_classes=4).astype('float64')))

    jaccard_score_ureter_pixelwide += K.eval(jaccard_score_2(y, tf.keras.utils.to_categorical(prediction, num_classes= 4).astype('float64')))
    jaccard_score_ureter_region_based += K.eval(jaccard_score_2(y, tf.keras.utils.to_categorical(reg_pred_1, num_classes=4).astype('float64')))
    jaccard_score_ureter_multiclass += K.eval(jaccard_score_2(y, tf.keras.utils.to_categorical(p_multiclass, num_classes=4).astype('float64')))
...
jaccard_score_arthery_pixelwide = jaccard_score_arthery_pixelwide / len(test_dataset)
jaccard_score_arthery_region_based = jaccard_score_arthery_region_based / len(test_dataset)
jaccard_score_arthery_multiclass = jaccard_score_arthery_multiclass / len(test_dataset)

jaccard_score_ureter_pixelwide = jaccard_score_ureter_pixelwide / len(test_dataset)
jaccard_score_ureter_region_based = jaccard_score_ureter_region_based / len(test_dataset)
jaccard_score_ureter_multiclass = jaccard_score_ureter_multiclass / len(test_dataset)
